...
from aruco_detector import run, run_webcam, ANCHOR_ID, HMD_ID
...
def on_pose_detected(anchor_T, hmd_T):
    ...
    print(f"[main] pos=({world_pos[0]:.3f}, {world_pos[1]:.3f}, {world_pos[2]:.3f}) "
...
if __name__ == "__main__":
    ...
    run_webcam(on_pose_detected)   # webcam (testing without ZED)
